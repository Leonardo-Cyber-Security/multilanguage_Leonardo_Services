...
Leonardo provides compute, storage, and network resources suitable for cloud and hybrid environments.  
...
You can consult the complete list here [Platform as a Service (PaaS)](PaaS.md).
...
You can consult the details here [Platform as a Service (PaaS)](PaaS.md).
...
You can consult the details here [Identity & Access Management (IAM) Service](PaaS.md#IAM).
...
You can consult the details here [Instant Messaging](PaaS.md#messaging).

## 11. Hybrid & Edge Services
...
**15.1. What certifications does Leonardo have for its services?**
You can consult all the certifications in the dedicated section [Certifications](Certifications.md)

**15.2. What does the ISO/IEC 20000 certification mean for customers?**
...
**15.3. Does Leonardo hold certifications related to information security?**
...
**15.4. Does Leonardo have its own CERT?**
...
**15.5. How does Leonardo ensure quality and regulatory compliance in Cyber & Security activities?**
...
**15.6 Is Leonardo compliant with national or international regulatory requirements?**
...
## 16. Cyber Security Services

**16.1 What security measures does Leonardo offer?**
- Data encryption with secure key management (KMS).  
...
**16.2 Does Leonardo supports a Zero Trust security model?**
...
**16.3. How does Leonardo manage cybersecurity emergencies?**
...
**16.4. Does Leonardo provide Cyber Resilience services?**
 ...
 **16.5. Are the data stored on Leonardo protected and “sovereign”?**
Yes:
...
**16.6 Does Leonardo collaborate with partners to enhance cloud security?**
Yes. For example:
...
**16.7 What international security standards does Leonardo follow?**
